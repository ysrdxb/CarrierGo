...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <h4><br> Guarantee for the export of a vehicle</h4>
            <p class="mb-1"><br>{{ $guarantee->date_displayed }}</p>
            <br>
            <p class="mb-1"> Dear Sir or Madam, <br>We have received an order from out client 
