...
<form wire:submit.prevent="saveEntry" wire:loading.attr="disabled">
    ...
    <div class="modal-footer">
        <input type="hidden" wire:model="entryType" value="merchant">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <button type="submit" class="btn btn-primary" wire:click="entryType = 'merchant'">Save Merchant</button>
    </div>
</form>
