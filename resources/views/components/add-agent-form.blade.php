@if (session('success_agent'))
<div class="alert alert-success alert-dismissible fade show" role="alert">
    {{ session('success_agent') }}
...
<form wire:submit.prevent="saveEntry" wire:loading.attr="disabled">
    ...
    <div class="modal-footer">
        <input type="hidden" wire:model="entryType" value="agent">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <button type="submit" class="btn btn-primary" wire:click="entryType = 'agent'">Save Agent</button>
    </div>
</form>
