...
<form wire:submit.prevent="saveEntry" wire:loading.attr="disabled">
    ...
    <div class="modal-footer">
        <input type="hidden" wire:model="entryType" value="carrier">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <button type="submit" class="btn btn-primary" wire:click="entryType = 'carrier'">Save Carrier</button>
    </div>
</form>
